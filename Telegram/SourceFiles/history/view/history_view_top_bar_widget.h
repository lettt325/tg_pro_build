...
public:
	...
	[[nodiscard]] rpl::producer<> indexMemorySelectionRequest() const {
		return _indexMemorySelection.events();
	}
...
private:
	...
	object_ptr<Ui::RoundButton> _indexMemory;
	...
	rpl::event_stream<> _indexMemorySelection;
