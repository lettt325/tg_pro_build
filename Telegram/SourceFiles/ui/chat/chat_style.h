...
struct MessageStyle {
	...
	style::icon historyTrashIcon = { Qt::Uninitialized };
...
public:
	...
	[[nodiscard]] const style::icon &historyTrashInvertedIcon() const {
		return _historyTrashInvertedIcon;
	}
...
private:
	...
	style::icon _historyTrashInvertedIcon = { Qt::Uninitialized };
